package starling.textures
{
   ...
   public class SubTexture extends Texture
   {
      ...
      public function SubTexture(param1:Object, param2:Texture, param3:Rectangle = null, param4:Boolean = false, param5:Rectangle = null, param6:Boolean = false)
      {
         super(param1);
         this.mParent = param2;
         this.mRegion = !!param3 ? param3.clone() : new Rectangle(0,0,param2.width,param2.height);
         this.mFrame = !!param5 ? param5.clone() : null;
         this.mOwnsParent = param4;
         this.mRotated = param6;
         this.mWidth = param6 ? this.mRegion.height : this.mRegion.width;
         this.mHeight = param6 ? this.mRegion.width : this.mRegion.height;
         ...
         if(Boolean(this.mFrame) && (this.mFrame.x > 0 || this.mFrame.y > 0 || this.mFrame.right < this.mWidth || this.mFrame.bottom < this.mHeight))
         {
         }
