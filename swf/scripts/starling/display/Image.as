package starling.display
{
   ...
   public class Image extends Quad
   {
      ...
      public static function fromBitmap(param1:Object, param2:Bitmap, param3:Boolean = true, param4:Number = 1) : Image
      {
         return new Image(Texture.fromBitmap(param1,param2,param3,false,param4));
      }
