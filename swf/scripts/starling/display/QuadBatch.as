   ...
   public class QuadBatch extends DisplayObject
   {
      ...
      private static function compileObject(param1:DisplayObject, param2:Vector.<QuadBatch>, param3:int, param4:Matrix, param5:Number = 1, param6:String = null, param7:Boolean = false) : int
      {
         ...
         else
         {
            ...
            if(param1 is Sprite && Boolean((param1 as Sprite).clipRect))
            {
            }
         }
      ...
      override public function dispose() : void
      {
         ...
         this.mNumQuads = 0;
         if(Boolean(this.mTexture) && this.mOwnsTexture)
         {
      ...
      public function addQuadBatch(param1:QuadBatch, param2:Number = 1, param3:Matrix = null, param4:String = null) : void
      {
         ...
         if(this.mNumQuads + _loc7_ > this.capacity)
         {
            this.capacity = this.mNumQuads + _loc7_;
         }
         if(this.mNumQuads == 0)
         {
         ...
         param1.mVertexData.copyTransformedTo(this.mVertexData,_loc6_,param3,0,_loc7_ * 4);
         if(_loc5_ != 1)
         {
            this.mVertexData.scaleAlpha(_loc6_,_loc5_,_loc7_ * 4);
         }
         this.mSyncRequired = true;
         this.mNumQuads += _loc7_;
      }
      ...
      private function getProgram(param1:Boolean) : Program3D
      {
         ...
         var _loc4_:Program3D = _loc2_.getProgram(_loc3_);
         if(!_loc4_)
         {
            if(!this.mTexture)
            {
            ...
            else
            {
               ...
               _loc6_ = _loc6_.replace("<???>",RenderSupport.getTextureLookupFlags(this.mTexture.format,this.mTexture.mipMapping,this.mTexture.repeat,this.smoothing));
            }
      ...
      public function addVertexData(param1:VertexData, param2:Number = 1, param3:Texture = null, param4:String = null, param5:String = null) : void
      {
         ...
         if(this.mNumQuads == 0)
         {
            ...
            this.mTexture = param3;
            this.mTinted = this.mForceTinted || param2 != 1;
            this.mSmoothing = param4;
            this.mVertexData.setPremultipliedAlpha(true);
         }
         param1.copyTransformedTo(this.mVertexData,_loc7_,null);
         this.mSyncRequired = true;
         ++this.mNumQuads;
      }
   }
