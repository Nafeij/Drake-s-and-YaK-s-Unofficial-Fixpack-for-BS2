package starling.events
{
   ...
   public class TouchProcessor
   {
      ...
      {
         return "mStage=" + this.mStage + ", mRoot=" + this.mRoot + ", mTouchMarker=" + this.mTouchMarker + ", mLastTaps=" + (!!this.mLastTaps ? this.mLastTaps.length.toString() : "<null>") + ", mMultiTapTime=" + this.mMultitapTime + ", mQueue=" + (!!this.mQueue ? this.mQueue.length.toString() : "<null>") + ", mCurrentTouches=" + (!!this.mCurrentTouches ? this.mCurrentTouches.length.toString() : "<null>");
      }
      ...
      public function cancelTouches() : void
      {
         ...
         {
            for each(_loc1_ in this.mCurrentTouches)
            {
      ...
      {
         var _loc8_:Touch = this.getCurrentTouch(param1);
         if(_loc8_ == null)
         {
