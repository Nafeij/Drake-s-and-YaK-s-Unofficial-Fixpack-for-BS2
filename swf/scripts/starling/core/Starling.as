package starling.core
{
   ...
   public class Starling extends EventDispatcher
   {
      ...
      public static var ignoreEvent:flash.events.Event;
      ...
      public function Starling(param1:Class, param2:flash.display.Stage, param3:Rectangle = null, param4:Stage3D = null, param5:String = "auto", param6:Object = "baselineConstrained")
      {
         ...
         if(Boolean(this.mStage3D.context3D) && this.mStage3D.context3D.driverInfo != "Disposed")
         {
            ...
            this.mProfile = "profile" in this.mStage3D.context3D ? String(this.mStage3D.context3D["profile"]) : param6 as String;
      ...
      public function nextFrame() : void
      {
         ...
         if(_loc2_ < 0)
         {
            _loc2_ = 1 / this.mNativeStage.frameRate;
         }
      ...
      public function render() : void
      {
         ...
         this.mSupport.setProjectionMatrix(this.mViewPort.x < 0 ? -this.mViewPort.x / _loc1_ : 0,this.mViewPort.y < 0 ? -this.mViewPort.y / _loc2_ : 0,this.mClippedViewPort.width / _loc1_,this.mClippedViewPort.height / _loc2_,this.mStage.stageWidth,this.mStage.stageHeight,this.mStage.cameraPosition);
      ...
      public function get contextValid() : Boolean
      {
         ...
         if(this.mContext)
         {
            _loc1_ = this.mContext.driverInfo;
