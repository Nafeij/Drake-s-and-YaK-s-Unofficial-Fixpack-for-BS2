package game.saga
{
   ...
   public class TutorialBattleVedrfell_pc implements IBattleTutorial
   {
      ...
      public function TutorialBattleVedrfell_pc(param1:SceneState)
      {
         super();
         ...
         this.helper = new HelperTutorialState(param1,[this.mode_setup,this.mode_move_waypoint_1,this.mode_move_waypoint_2,this.mode_move_confirm,this.mode_move_wait,this.mode_attack_target,this.mode_attack_confirm,this.mode_attack_wait,this.mode_attacked_target,this.mode_dredge_move,this.mode_dredge_attack,this.mode_arrive_party,this.mode_wait_for_horn,this.mode_show_horn]);
      ...
      {
         this.logger.info("TutorialBattleVedrfell mode_move_waypoint_1");
         ...
         this.helper.tt = this.config.tutorialLayer.createTooltip("ScenePage|scene_view|boards|focusedBoardView|underlay|marker|tile",TutorialTooltipAlign.TOP,TutorialTooltipAnchor.NONE,-32,this.config.context.locale.translate(LocaleCategory.TUTORIAL,"tut_battle_vedrfell_ludin_waypoint_1"),true,false,0);
      ...
      public function mode_move_waypoint_2(param1:Function) : void
      {
         ...
         this.config.sceneControllerConfig.allowMoveTile = this.battleHandler.fsm.board.tiles.getTileByLocation(_loc2_);
         this.config.sceneControllerConfig.notify();
         this.helper.tt = this.config.tutorialLayer.createTooltip("ScenePage|scene_view|boards|focusedBoardView|underlay|marker|tile",TutorialTooltipAlign.TOP,TutorialTooltipAnchor.NONE,-32,this.config.context.locale.translate(LocaleCategory.TUTORIAL,"tut_battle_vedrfell_ludin_waypoint_2"),true,false,0);
         var _loc3_:IBattleMove = this.battleHandler.fsm.turn.move;
         _loc3_.suppressCommit = true;
         _loc3_.addEventListener(BattleMoveEvent.WAYPOINT,this.moveWaypointHandler);
      }
      
      public function mode_move_confirm(param1:Function) : void
      {
         ...
         _loc2_.suppressCommit = false;
         this.helper.tt = this.config.tutorialLayer.createTooltip("ScenePage|BattleHudPage|assets.move_popup",TutorialTooltipAlign.TOP,TutorialTooltipAnchor.NONE,-32,this.config.context.locale.translate(LocaleCategory.TUTORIAL,"tut_battle_vedrfell_ludin_move_confirm"),true,false,0);
         _loc2_.addEventListener(BattleMoveEvent.COMMITTED,this.moveCommittedHandler);
      }
