package game.saga
{
   ...
   public class TutorialBattleStrandGreatHall_pc
   {
      ...
      public function TutorialBattleStrandGreatHall_pc(param1:SceneState)
      {
      ...
      {
         var _loc2_:TutorialBattleStrandGreatHall = null;
         if(this.battleHandler)
         {
            _loc2_ = param1.cmd.config as TutorialBattleStrandGreatHall;
            _loc2_.cleanup();
         }
      }
      ...
      {
         var self:Function = param1;
         this.helper.tt = this.config.tutorialLayer.createTooltip("ScenePage|BattleHudPage",TutorialTooltipAlign.BOTTOM,TutorialTooltipAnchor.CENTER,50,this.config.context.locale.translate(LocaleCategory.TUTORIAL,"tut_battle_intro_mode"),false,true,0);
      ...
      public function mode_move_click(param1:Function) : void
      {
         ...
         this.helper.tt = this.config.tutorialLayer.createTooltip("ScenePage|scene_view|boards|focusedBoardView|underlay|marker|tile",TutorialTooltipAlign.TOP,TutorialTooltipAnchor.NONE,-32,this.config.context.locale.translate(LocaleCategory.TUTORIAL,"tut_move_click_mode"),true,false,0);
      }
      ...
      public function mode_attack_target(param1:Function) : void
      {
         ...
         this.config.sceneControllerConfig.notify();
         this.helper.tt = this.config.tutorialLayer.createTooltip("ScenePage|scene_view|boards|focusedBoardView|entityViews|npc+3+tutorial_raider|shadowBitmapWrapper",TutorialTooltipAlign.BOTTOM,TutorialTooltipAnchor.NONE,16,this.config.context.locale.translate(LocaleCategory.TUTORIAL,"tut_attack_target_mode"),true,false,0);
         this.helper.tt.addEventListener(TutorialTooltip.EVENT_BUTTON,function callback(param1:Event):void
         {
            helper.tt.removeEventListener(TutorialTooltip.EVENT_BUTTON,callback);
            battleFsm.interact = ruffian3;
         });
      }
      ...
      public function mode_attack_confirm(param1:Function) : void
      {
         ...
         this.helper.tt = this.config.tutorialLayer.createTooltip("ScenePage|BattleHudPage|assets.enemy_popup|button_str|damage_flag",TutorialTooltipAlign.BOTTOM,TutorialTooltipAnchor.CENTER,16,this.config.context.locale.translate(LocaleCategory.TUTORIAL,"tut_battle_attack_confirm_mode"),true,false,0);
      }
      ...
      public function mode_attack_killed_renown(param1:Function) : void
      {
         var uid:String;
         var self:Function = param1;
         GmA.trackCustom("prg_tut1_attack1",0);
         if(this.saga)
         {
      ...
      public function mode_warrior_move_click(param1:Function) : void
      {
         ...
         this.config.sceneControllerConfig.allowMoveTile = this.battleHandler.fsm.board.tiles.getTileByLocation(_loc2_);
         this.config.sceneControllerConfig.notify();
         this.helper.tt = this.config.tutorialLayer.createTooltip("ScenePage|scene_view|boards|focusedBoardView|underlay|marker|tile",TutorialTooltipAlign.BOTTOM,TutorialTooltipAnchor.NONE,32,this.config.context.locale.translate(LocaleCategory.TUTORIAL,"tut_battle_warrior_move_click_mode"),true,false,0);
      }
      ...
      {
         var uid:String = null;
         var warhawk:IBattleEntity = null;
         var self:Function = param1;
         uid = this.config.fsm.credentials.userId.toString();
         warhawk = this.battleHandler.fsm.board.entities[uid + "+1+warhawk_tut"];
         ...
         this.config.sceneControllerConfig.notify();
         this.helper.tt = this.config.tutorialLayer.createTooltip("ScenePage|scene_view|boards|focusedBoardView|entityViews|" + uid + "+1+warhawk_tut|shadowBitmapWrapper",TutorialTooltipAlign.BOTTOM,TutorialTooltipAnchor.NONE,32,this.config.context.locale.translate(LocaleCategory.TUTORIAL,"tut_battle_warrior_special_click_mode"),true,false,0);
         this.helper.tt.addEventListener(TutorialTooltip.EVENT_BUTTON,function callback(param1:Event):void
         {
            helper.tt.removeEventListener(TutorialTooltip.EVENT_BUTTON,callback);
            battleFsm.interact = warhawk;
         });
      }
      ...
      public function mode_warrior_self_popup(param1:Function) : void
      {
         ...
         this.config.sceneControllerConfig.allowEntities.splice(0,this.config.sceneControllerConfig.allowEntities.length);
         this.config.sceneControllerConfig.notify();
         this.helper.tt = this.config.tutorialLayer.createTooltip("ScenePage|BattleHudPage|assets.self_popup|basic|ability_button|placeholder",TutorialTooltipAlign.BOTTOM,TutorialTooltipAnchor.NONE,32,this.config.context.locale.translate(LocaleCategory.TUTORIAL,"tut_battle_warrior_self_popup_mode"),true,false,0);
      }
      ...
      public function mode_warrior_tempest_target(param1:Function) : void
      {
         ...
         this.config.sceneControllerConfig.notify();
         this.helper.tt = this.config.tutorialLayer.createTooltip("ScenePage|scene_view|boards|focusedBoardView|entityViews|npc+2+tutorial_raider|shadowBitmapWrapper",TutorialTooltipAlign.BOTTOM,TutorialTooltipAnchor.NONE,16,this.config.context.locale.translate(LocaleCategory.TUTORIAL,"tut_battle_warrior_tempest_target_mode"),true,false,0);
         this.helper.tt.addEventListener(TutorialTooltip.EVENT_BUTTON,function callback(param1:Event):void
         {
            helper.tt.removeEventListener(TutorialTooltip.EVENT_BUTTON,callback);
            if(battleFsm._ability)
            {
               battleFsm._ability._targetSet.setTarget(ruffian2);
               battleFsm.turn.notifyTargetsUpdated();
            }
            battleFsm.interact = ruffian2;
         });
      }
      ...
      {
         var self:Function = param1;
         GmA.trackCustom("tut1_tempest",0);
         if(this.saga)
         {
      ...
      {
         var chieftain:IBattleEntity = null;
         var self:Function = param1;
         chieftain = this.battleHandler.fsm.board.entities["npc+0+tutorial_chieftain"];
         this.battleHandler.state.loader.viewSprite.boards.focusedBoardView.centerOnEntity(chieftain);
         this.config.sceneControllerConfig.allowHover = true;
         this.config.sceneControllerConfig.allowEntities.splice(0,this.config.sceneControllerConfig.allowEntities.length);
         this.config.sceneControllerConfig.allowEntities.push(chieftain);
         this.config.sceneControllerConfig.notify();
         this.helper.tt = this.config.tutorialLayer.createTooltip("ScenePage|scene_view|boards|focusedBoardView|entityViews|npc+0+tutorial_chieftain|shadowBitmapWrapper",TutorialTooltipAlign.BOTTOM,TutorialTooltipAnchor.NONE,16,this.config.context.locale.translate(LocaleCategory.TUTORIAL,"tut_battle_click_chieftain_mode"),true,true,0);
         this.helper.tt.addEventListener(TutorialTooltip.EVENT_BUTTON,function callback(param1:Event):void
         {
            helper.tt.removeEventListener(TutorialTooltip.EVENT_BUTTON,callback);
            battleFsm.interact = chieftain;
         });
      }
      ...
      public function mode_popup_chieftain(param1:Function) : void
      {
         ...
         this.config.sceneControllerConfig.allowHover = false;
         this.config.sceneControllerConfig.notify();
         this.helper.tt = this.config.tutorialLayer.createTooltip("ScenePage|BattleHudPage|assets.enemy_popup|button_str|damage_flag",TutorialTooltipAlign.BOTTOM,TutorialTooltipAnchor.CENTER,16,this.config.context.locale.translate(LocaleCategory.TUTORIAL,"tut_battle_popup_chieftain_mode"),true,false,0);
      }
