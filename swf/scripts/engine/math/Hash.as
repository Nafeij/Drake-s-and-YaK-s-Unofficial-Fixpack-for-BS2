package engine.math
{
   public class Hash
   {
      ...
      public static function PJWHash(param1:String) : uint
      {
         ...
         var _loc5_:uint = uint(4294967295) << _loc2_ - _loc4_;
         var _loc6_:uint = 0;
         var _loc7_:uint = 0;
         var _loc8_:int = 0;
         while(_loc8_ < param1.length)
         {
            _loc6_ = (_loc6_ << _loc4_) + uint(param1.charCodeAt(_loc8_));
            if((_loc7_ = _loc6_ & _loc5_) != 0)
            {
               _loc6_ = (_loc6_ ^ _loc7_ >> _loc3_) & ~_loc5_;
            }
            _loc8_++;
         }
         return _loc6_;
      ...
      public static function ELFHash(param1:String) : uint
      {
         ...
         {
            _loc2_ = (_loc2_ << 4) + uint(param1.charCodeAt(_loc4_));
            _loc3_ = _loc2_ & 4026531840;
            if(_loc3_ != 0)
            {
               _loc2_ ^= _loc3_ >> 24;
            }
      ...
      public static function SDBMHash(param1:String) : uint
      {
         ...
         while(_loc3_ < param1.length)
         {
            _loc2_ = uint(param1.charCodeAt(_loc3_)) + (_loc2_ << 6) + (_loc2_ << 16) - _loc2_;
            _loc3_++;
         }
         return _loc2_;
      }
      ...
      public static function DJBHash(param1:String) : uint
      {
         ...
         while(_loc3_ < param1.length)
         {
            _loc2_ = (_loc2_ << 5) + _loc2_ + uint(param1.charCodeAt(_loc3_));
            _loc3_++;
         }
         return _loc2_;
      }
      ...
      public static function DEKHash(param1:String) : uint
      {
         ...
         while(_loc3_ < param1.length)
         {
            _loc2_ = _loc2_ << 5 ^ _loc2_ >> 27 ^ uint(param1.charCodeAt(_loc3_));
            _loc3_++;
         }
         return _loc2_;
      }
      ...
      public static function BPHash(param1:String) : uint
      {
         ...
         while(_loc3_ < param1.length)
         {
            _loc2_ = _loc2_ << 7 ^ uint(param1.charCodeAt(_loc3_));
            _loc3_++;
         }
         return _loc2_;
      }
