package engine.saga.action
{
   ...
   public class Action_Kill extends Action
   {
       
      
      public function Action_Kill(param1:ActionDef, param2:Saga)
      {
         super(param1,param2);
      }
      ...
      override protected function handleStarted() : void
      {
         ...
         var _loc6_:IBattleAbilityDef = _loc5_.fetchIBattleAbilityDef("abl_kill");
