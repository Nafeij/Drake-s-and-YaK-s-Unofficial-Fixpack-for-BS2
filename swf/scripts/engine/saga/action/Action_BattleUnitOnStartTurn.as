package engine.saga.action
{
   ...
   public class Action_BattleUnitOnStartTurn extends Action
   {
       
      
      public function Action_BattleUnitOnStartTurn(param1:ActionDef, param2:Saga)
      {
         super(param1,param2);
      }
      ...
      override protected function handleStarted() : void
      {
         ...
         {
            _loc4_.effects.handleStartTurn();
         }
         end();
      }
   }
