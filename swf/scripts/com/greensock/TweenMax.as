package com.greensock
{
   ...
   public class TweenMax extends TweenLite implements IEventDispatcher
   {
      ...
      public static var DEBUG_CTOR:Boolean;
      ...
      public function TweenMax(param1:Object, param2:Number, param3:Object)
      {
         ...
         if(DEBUG_CTOR)
         {
            _loc4_ = new Error("stacktracker");
            _loc5_ = _loc4_.getStackTrace();
            this._debugCtor(_loc5_);
         }
      ...
      private function _debugCtor(param1:String) : void
      {
         ...
         {
            if(TweenCore.TWEENMAX_SCALEFORM)
            {
               _loc4_ = _loc4_.replace(/^.*::/,"");
               _loc4_ = _loc4_.replace(/^\s*at /,"");
               _loc3_ += _loc4_ + " == ";
            }
            else
            {
